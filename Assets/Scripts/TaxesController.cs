...
public class TaxesController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        startsLeft = tm.startsLeft;
        startsRight = tm.startsRight;
    ...
    void Update()
    {
        // Wait two seconds, and then change the value of objectSpawned in order to toggle the start-position (left/right)
        StartCoroutine(Wait());
